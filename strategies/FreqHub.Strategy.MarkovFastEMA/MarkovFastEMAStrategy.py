...
class MarkovFastEMAStrategy(IStrategy):
    """
    Markov variant with fast EMA confirmation.
    """
    ...
    fast_ema = IntParameter(8, 30, default=12, space="buy", optimize=True)
    slow_ema = IntParameter(30, 80, default=55, space="buy", optimize=True)
