...
class MarkovRSIStrategy(IStrategy):
    """
    Markov strategy with optimizable RSI thresholds.
    """

    INTERFACE_VERSION = 3

    # ROI/stoploss optimized via properties
    timeframe = "1h"
    ...
    # --- Optimizable RSI parameters ---
    rsi_period = IntParameter(10, 21, default=14, space="buy", optimize=True)
    rsi_low = IntParameter(30, 50, default=40, space="buy", optimize=True)
    rsi_high = IntParameter(55, 75, default=60, space="buy", optimize=True)
